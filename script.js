if (typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') {
    console.error("GSAP or ScrollTrigger not loaded. Check CDN links.");
} else {
...
// Check if footer is in view on load and animate immediately if true
function checkFooterInView() {
    const footer = document.querySelector(".footer");
    if (footer && footer.getBoundingClientRect().top < window.innerHeight * 0.98) {
